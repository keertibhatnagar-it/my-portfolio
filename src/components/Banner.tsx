...
const Banner = () => {
  return (
    <section id="home" className="min-h-[calc(100vh-90px)] max-w-[1000px] flex items-start justify-start pt-12 sm:pt-16 md:pt-20 lg:pt-[100px] px-4 sm:px-6 md:px-8 lg:px-0 pb-12 sm:pb-16 md:pb-20 flex-col mx-auto">
