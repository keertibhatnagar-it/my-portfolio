          ...
          >
            <div className="flex-1 relative group w-full md:w-auto">
              <a
                ...
                className="block relative z-10 w-full h-[200px] sm:h-[250px] md:h-[280px] lg:h-[300px] bg-[var(--light-navy)] rounded overflow-hidden border border-[var(--primary-green)]/20 hover:border-[var(--primary-green)]/50 transition-all duration-300"
              >
            ...
            <div className="flex-1 flex flex-col gap-3 sm:gap-4 md:gap-5 w-full md:w-auto">
              ...
              <div className="bg-[var(--light-navy)] p-4 sm:p-5 md:p-6 rounded border border-[var(--primary-green)]/10 shadow-lg">
                <p className="text-[var(--slate)] text-xs sm:text-sm md:text-base leading-relaxed mb-3 sm:mb-4 md:mb-5">
                  {project.description}
                </p>
                <ul className="flex flex-wrap gap-2 sm:gap-3 mb-3 sm:mb-4 md:mb-5 text-[10px] sm:text-xs md:text-sm font-mono text-[var(--light-slate)]">
                  {project.tech.map((tech, techIndex) => (
                    <li key={techIndex} className="px-2 py-1">{tech}</li>
                  ))}
                </ul>
